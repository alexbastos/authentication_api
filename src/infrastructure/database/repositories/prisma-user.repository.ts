...
export class PrismaUserRepository implements IUserRepository {
  ...
  private toDomain(record: any): User {
    return new User({
      ...
      address: {
        street: record.addressStreet ?? null,
        city: record.addressCity ?? null,
        state: record.addressState ?? null,
        zipCode: record.addressZipCode ?? null,
        country: record.addressCountry ?? null,
      },
    });
  }
}
